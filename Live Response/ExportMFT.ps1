...
.DESCRIPTION
This module exports the master file table (MFT) and writes it to C:\Windows\TEMP.
...
$RemoteScriptBlock = {
    ...
    $OutputFilePath = "C:\WINDOWS\TEMP\$($env:COMPUTERNAME)-MFT_EXPORT" + (get-date -f _yyyyMMdd-HHmmss) + ".Mft"        
